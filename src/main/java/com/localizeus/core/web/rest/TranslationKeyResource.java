...
public class TranslationKeyResource {
    ...
    public ResponseEntity<List<TranslationKeyDTO>> getAllTranslationKeys(@RequestParam(name = "projectId", required = false) String projectId, Pageable pageable) {
        Page<TranslationKeyDTO> page;
