  ...
  return (
    <div>
      <h2 id="project-heading">
        <Translate contentKey="localizeusApp.project.home.title">Projects</Translate>
        <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
          <FontAwesomeIcon icon="plus" />
          &nbsp;
          <Translate contentKey="localizeusApp.project.home.createLabel">Create new Project</Translate>
        </Link>
      </h2>
        ...
        {projectList && projectList.length > 0 ? (
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="localizeusApp.project.home.notFound">No Projects found</Translate>
            </div>
          )
        )}
      </div>
