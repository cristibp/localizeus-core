  ...
  return (
    <div>
      <h2 id="service-subscription-heading">
        <Translate contentKey="localizeusApp.serviceSubscription.home.title">Service Subscriptions</Translate>
        <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
          <FontAwesomeIcon icon="plus" />
          &nbsp;
          <Translate contentKey="localizeusApp.serviceSubscription.home.createLabel">Create new Service Subscription</Translate>
        </Link>
      </h2>
        ...
        {serviceSubscriptionList && serviceSubscriptionList.length > 0 ? (
            ...
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('start')}>
                  <Translate contentKey="localizeusApp.serviceSubscription.start">Start</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('end')}>
                  <Translate contentKey="localizeusApp.serviceSubscription.end">End</Translate> <FontAwesomeIcon icon="sort" />
                </th>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="localizeusApp.serviceSubscription.home.notFound">No Service Subscriptions found</Translate>
            </div>
          )
        )}
      </div>
