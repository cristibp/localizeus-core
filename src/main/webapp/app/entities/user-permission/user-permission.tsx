  ...
  return (
    <div>
      <h2 id="user-permission-heading">
        <Translate contentKey="localizeusApp.userPermission.home.title">User Permissions</Translate>
        <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
          <FontAwesomeIcon icon="plus" />
          &nbsp;
          <Translate contentKey="localizeusApp.userPermission.home.createLabel">Create new User Permission</Translate>
        </Link>
      </h2>
        ...
        {userPermissionList && userPermissionList.length > 0 ? (
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="localizeusApp.userPermission.home.notFound">No User Permissions found</Translate>
            </div>
          )
        )}
      </div>
