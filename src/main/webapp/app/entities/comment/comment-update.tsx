  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="localizeusApp.comment.home.createOrEditLabel">
            <Translate contentKey="localizeusApp.comment.home.createOrEditLabel">Create or edit a Comment</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
            ...
            <AvForm model={isNew ? {} : commentEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                <Label id="valueLabel" for="comment-value">
                  <Translate contentKey="localizeusApp.comment.value">Value</Translate>
                </Label>
