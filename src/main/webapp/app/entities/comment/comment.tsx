  ...
  return (
    <div>
      <h2 id="comment-heading">
        <Translate contentKey="localizeusApp.comment.home.title">Comments</Translate>
        <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
          <FontAwesomeIcon icon="plus" />
          &nbsp;
          <Translate contentKey="localizeusApp.comment.home.createLabel">Create new Comment</Translate>
        </Link>
      </h2>
          ...
          {commentList && commentList.length > 0 ? (
            ...
            !loading && (
              <div className="alert alert-warning">
                <Translate contentKey="localizeusApp.comment.home.notFound">No Comments found</Translate>
              </div>
            )
          )}
        </InfiniteScroll>
