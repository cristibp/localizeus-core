  ...
  return (
    <div>
      <h2 id="user-project-permission-heading">
        <Translate contentKey="localizeusApp.userProjectPermission.home.title">User Project Permissions</Translate>
        <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
          <FontAwesomeIcon icon="plus" />
          &nbsp;
          <Translate contentKey="localizeusApp.userProjectPermission.home.createLabel">Create new User Project Permission</Translate>
        </Link>
      </h2>
        ...
        {userProjectPermissionList && userProjectPermissionList.length > 0 ? (
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="localizeusApp.userProjectPermission.home.notFound">No User Project Permissions found</Translate>
            </div>
          )
        )}
      </div>
