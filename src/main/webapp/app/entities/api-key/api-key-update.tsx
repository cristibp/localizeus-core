  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="localizeusApp.apiKey.home.createOrEditLabel">
            <Translate contentKey="localizeusApp.apiKey.home.createOrEditLabel">Create or edit a ApiKey</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
