  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="localizeusApp.discussion.home.createOrEditLabel">
            <Translate contentKey="localizeusApp.discussion.home.createOrEditLabel">Create or edit a Discussion</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
            ...
            <AvForm model={isNew ? {} : discussionEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                <Label id="valueLabel" for="discussion-value">
                  <Translate contentKey="localizeusApp.discussion.value">Value</Translate>
                </Label>
