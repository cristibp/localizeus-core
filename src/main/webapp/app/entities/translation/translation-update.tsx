  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="localizeusApp.translation.home.createOrEditLabel">
            <Translate contentKey="localizeusApp.translation.home.createOrEditLabel">Create or edit a Translation</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
            ...
            <AvForm model={isNew ? {} : translationEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                <Label id="valueLabel" for="translation-value">
                  <Translate contentKey="localizeusApp.translation.value">Value</Translate>
                </Label>
