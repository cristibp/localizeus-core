  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="localizeusApp.company.home.createOrEditLabel">
            <Translate contentKey="localizeusApp.company.home.createOrEditLabel">Create or edit a Company</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
            ...
            <AvForm model={isNew ? {} : companyEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                <Label id="nameLabel" for="company-name">
                  <Translate contentKey="localizeusApp.company.name">Name</Translate>
                </Label>
                <AvField id="company-name" type="text" name="name" />
              </AvGroup>
              <AvGroup>
                <Label id="emailLabel" for="company-email">
                  <Translate contentKey="localizeusApp.company.email">Email</Translate>
                </Label>
                <AvField id="company-email" type="text" name="email" />
              </AvGroup>
              <AvGroup>
                <Label id="phoneLabel" for="company-phone">
                  <Translate contentKey="localizeusApp.company.phone">Phone</Translate>
                </Label>
