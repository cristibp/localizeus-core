  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="localizeusApp.keyLabel.home.createOrEditLabel">
            <Translate contentKey="localizeusApp.keyLabel.home.createOrEditLabel">Create or edit a KeyLabel</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
            ...
            <AvForm model={isNew ? {} : keyLabelEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                <Label id="valueLabel" for="key-label-value">
                  <Translate contentKey="localizeusApp.keyLabel.value">Value</Translate>
                </Label>
                <AvField id="key-label-value" type="text" name="value" />
              </AvGroup>
              <AvGroup>
                <Label for="key-label-translationkey">
                  <Translate contentKey="localizeusApp.keyLabel.translationkey">Translationkey</Translate>
                </Label>
