...
export const TransactionDeleteDialog = (props: ITransactionDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="localizeusApp.transaction.delete.question">
        <Translate contentKey="localizeusApp.transaction.delete.question" interpolate={{ id: transactionEntity.id }}>
