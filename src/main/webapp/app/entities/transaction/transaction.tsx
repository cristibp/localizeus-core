  ...
  return (
    <div>
      <h2 id="transaction-heading">
        <Translate contentKey="localizeusApp.transaction.home.title">Transactions</Translate>
        <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
          <FontAwesomeIcon icon="plus" />
          &nbsp;
          <Translate contentKey="localizeusApp.transaction.home.createLabel">Create new Transaction</Translate>
        </Link>
      </h2>
        ...
        {transactionList && transactionList.length > 0 ? (
            ...
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('date')}>
                  <Translate contentKey="localizeusApp.transaction.date">Date</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('status')}>
                  <Translate contentKey="localizeusApp.transaction.status">Status</Translate> <FontAwesomeIcon icon="sort" />
                </th>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="localizeusApp.transaction.home.notFound">No Transactions found</Translate>
            </div>
          )
        )}
      </div>
