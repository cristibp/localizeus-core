  ...
  return (
    <div>
      <h2 id="project-history-heading">
        <Translate contentKey="localizeusApp.projectHistory.home.title">Project Histories</Translate>
        <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
          <FontAwesomeIcon icon="plus" />
          &nbsp;
          <Translate contentKey="localizeusApp.projectHistory.home.createLabel">Create new Project History</Translate>
        </Link>
      </h2>
          ...
          {projectHistoryList && projectHistoryList.length > 0 ? (
              ...
              <thead>
                <tr>
                  ...
                  <th className="hand" onClick={sort('action')}>
                    <Translate contentKey="localizeusApp.projectHistory.action">Action</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={sort('oldValue')}>
                    <Translate contentKey="localizeusApp.projectHistory.oldValue">Old Value</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
              ...
              <tbody>
                {projectHistoryList.map((projectHistory, i) => (
                  <tr key={`entity-${i}`}>
                    ...
                    <td>
                      <Translate contentKey={`localizeusApp.ProjectActions.${projectHistory.action}`} />
                    </td>
            ...
            !loading && (
              <div className="alert alert-warning">
                <Translate contentKey="localizeusApp.projectHistory.home.notFound">No Project Histories found</Translate>
              </div>
            )
          )}
        </InfiniteScroll>
