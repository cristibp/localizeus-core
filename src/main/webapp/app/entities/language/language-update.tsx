  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="localizeusApp.language.home.createOrEditLabel">
            <Translate contentKey="localizeusApp.language.home.createOrEditLabel">Create or edit a Language</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
            ...
            <AvForm model={isNew ? {} : languageEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                <Label id="languageNameLabel" for="language-languageName">
                  <Translate contentKey="localizeusApp.language.languageName">Language Name</Translate>
                </Label>
