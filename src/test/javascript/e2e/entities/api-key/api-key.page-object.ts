...
export class ApiKeyDeleteDialog {
  ...
  private dialogTitle: ElementFinder = element(by.id('localizeusApp.apiKey.delete.question'));
...
export default class ApiKeyComponentsPage {
  ...
  async deleteApiKey() {
    ...
    expect(await apiKeyDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/localizeusApp.apiKey.delete.question/);
