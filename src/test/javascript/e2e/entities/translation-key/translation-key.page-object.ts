...
export class TranslationKeyDeleteDialog {
  ...
  private dialogTitle: ElementFinder = element(by.id('localizeusApp.translationKey.delete.question'));
...
export default class TranslationKeyComponentsPage {
  ...
  async deleteTranslationKey() {
    ...
    expect(await translationKeyDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/localizeusApp.translationKey.delete.question/);
