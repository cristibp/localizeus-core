...
export class CommentDeleteDialog {
  ...
  private dialogTitle: ElementFinder = element(by.id('localizeusApp.comment.delete.question'));
...
export default class CommentComponentsPage {
  ...
  async deleteComment() {
    ...
    expect(await commentDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/localizeusApp.comment.delete.question/);
