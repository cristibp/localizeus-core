...
export class UserPermissionDeleteDialog {
  ...
  private dialogTitle: ElementFinder = element(by.id('localizeusApp.userPermission.delete.question'));
...
export default class UserPermissionComponentsPage {
  ...
  async deleteUserPermission() {
    ...
    expect(await userPermissionDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/localizeusApp.userPermission.delete.question/);
