...
export class ProjectDeleteDialog {
  ...
  private dialogTitle: ElementFinder = element(by.id('localizeusApp.project.delete.question'));
...
export default class ProjectComponentsPage {
  ...
  async deleteProject() {
    ...
    expect(await projectDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/localizeusApp.project.delete.question/);
