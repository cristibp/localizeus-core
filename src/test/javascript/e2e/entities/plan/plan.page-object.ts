...
export class PlanDeleteDialog {
  ...
  private dialogTitle: ElementFinder = element(by.id('localizeusApp.plan.delete.question'));
...
export default class PlanComponentsPage {
  ...
  async deletePlan() {
    ...
    expect(await planDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/localizeusApp.plan.delete.question/);
