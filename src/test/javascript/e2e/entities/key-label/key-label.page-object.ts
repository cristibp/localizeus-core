...
export class KeyLabelDeleteDialog {
  ...
  private dialogTitle: ElementFinder = element(by.id('localizeusApp.keyLabel.delete.question'));
...
export default class KeyLabelComponentsPage {
  ...
  async deleteKeyLabel() {
    ...
    expect(await keyLabelDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/localizeusApp.keyLabel.delete.question/);
