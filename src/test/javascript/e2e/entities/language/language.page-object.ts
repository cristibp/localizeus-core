...
export class LanguageDeleteDialog {
  ...
  private dialogTitle: ElementFinder = element(by.id('localizeusApp.language.delete.question'));
...
export default class LanguageComponentsPage {
  ...
  async deleteLanguage() {
    ...
    expect(await languageDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/localizeusApp.language.delete.question/);
