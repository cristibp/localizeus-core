...
export class TransactionDeleteDialog {
  ...
  private dialogTitle: ElementFinder = element(by.id('localizeusApp.transaction.delete.question'));
...
export default class TransactionComponentsPage {
  ...
  async deleteTransaction() {
    ...
    expect(await transactionDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/localizeusApp.transaction.delete.question/);
