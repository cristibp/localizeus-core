...
export class CompanyDeleteDialog {
  ...
  private dialogTitle: ElementFinder = element(by.id('localizeusApp.company.delete.question'));
...
export default class CompanyComponentsPage {
  ...
  async deleteCompany() {
    ...
    expect(await companyDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/localizeusApp.company.delete.question/);
