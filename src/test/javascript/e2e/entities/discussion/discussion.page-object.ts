...
export class DiscussionDeleteDialog {
  ...
  private dialogTitle: ElementFinder = element(by.id('localizeusApp.discussion.delete.question'));
...
export default class DiscussionComponentsPage {
  ...
  async deleteDiscussion() {
    ...
    expect(await discussionDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/localizeusApp.discussion.delete.question/);
