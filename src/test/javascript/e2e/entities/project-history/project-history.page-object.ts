...
export class ProjectHistoryDeleteDialog {
  ...
  private dialogTitle: ElementFinder = element(by.id('localizeusApp.projectHistory.delete.question'));
...
export default class ProjectHistoryComponentsPage {
  ...
  async deleteProjectHistory() {
    ...
    expect(await projectHistoryDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/localizeusApp.projectHistory.delete.question/);
